...
| Prop     | Type | Required | Notes                                                                                                |
| -------- | ---- | -------- | ---------------------------------------------------------------------------------------------------- |
| _(none)_ | —    | —        | Reads current path via `usePathname` hook in a Client Component sub-element for active-state styling |
...
| Prop     | Type | Required | Notes                                             |
| -------- | ---- | -------- | ------------------------------------------------- |
| _(none)_ | —    | —        | Skeleton — all content is static placeholder copy |
